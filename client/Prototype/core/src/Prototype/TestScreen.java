...
public class TestScreen implements Screen {
	...
	public TestScreen(Prototype prototype) {
		...
		//ui components
		//remainTimeBox = new Image(game.assets.remainTimeBoxTexture);
		...
		///portraitNormal = new Image(game.assets.portraitNormalTexture);
	...
	public void show() {
		...
		//game.assets.introBackground.play(0.2f);
		stage.addActor(game.world);
	...
	public void render(float delta) {
		...
		//remainTime label
		//remainTimeLabel.setPosition(playerCamera.position.x - remainTimeLabel.getWidth()/2, playerCamera.position.y + playerCamera.viewportHeight/2 - remainTimeLabel.getHeight());
		...
		//"objectives" label
		//objectivesLabel.setPosition(playerCamera.position.x - playerCamera.viewportWidth/2 + 10, playerCamera.position.y + playerCamera.viewportHeight/2 - objectivesLabel.getHeight());
		...
		if (nearbyObj != null && !nearbyObj.interacted()) {
			//stage.getBatch().setProjectionMatrix(playerCamera.combined);
			stage.getBatch().begin();
